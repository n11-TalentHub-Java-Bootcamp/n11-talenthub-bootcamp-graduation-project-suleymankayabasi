...
const Form = () => {
	...
	const handleSubmit = (e) => {
		...
		fetch("http://localhost:8080/customer/create", {
			...
			res.status === 200 ? alert("Kullanıcı Kayıt Başarılı") : alert("Kullanıcı Kayıt Başarısız");
		});
	};

	return (
		<div className='basis-5/6 bg-white rounded shadow-lg p-8 m-4'>
			<h1 className='block w-full text-center text-grey-darkest font-bold uppercase bg-teal-500 py-2 mb-6'>
				Kredi Başvuru Formu
			</h1>
